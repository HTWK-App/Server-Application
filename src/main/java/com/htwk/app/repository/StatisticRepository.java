...
public class StatisticRepository {
   ...
   */
  public AtomicLong getStaffRequests() {
   ...
   */
  public AtomicLong getBuildingRequests() {
   ...
   */
  public AtomicLong getSportRequests() {
   ...
   */
  public AtomicLong getNewsRequests() {
    return newsRequests;
  }
   ...
   */
  public AtomicLong getMailboxRequests() {
   ...
   */
  public AtomicLong getWeatherRequests() {
   ...
   */
  public AtomicLong getTimetableRequests() {
   ...
   */
  public EvictingQueue<Long> getExecutionTimes() {
